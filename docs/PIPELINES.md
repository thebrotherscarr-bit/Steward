...
| version | `cargo run -q -p atlas -- --version` | prints 0.1.3 |
...
| mcp-version | `cd line && go run ./cmd/atlas-mcp --version` | 0.1.3 |
...
| tui-version | `cd line && go run ./cmd/atlas-tui --version` | atlas-tui 0.1.3 |
...
| version | Response contains 0.1.3 | version matches |
